...
//task: Sum of two numbers
```
Вторият ред е обръщение към компилатора, което казва, че ще са ни необходими операции за вход и изход, тъй като искаме да изведем сумата на екрана.
```c++
#include <iostream.h>
```
...
Вътре в главната функция **main** се намират следните дефиниции и декларации.
```c++
double a = 2.5;
double b = 3.61;
double sum;
...
+ управляващи 
    ...
    + оператор за цикъл
    + и др.
+ оператори за управление на динамична памет(за сега няма да ги използваме)
